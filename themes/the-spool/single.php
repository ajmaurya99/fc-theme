<?php
/**
 * The template for displaying all single posts Full Version
 *
                            ...
                            <div class="table-cell">
                                ...
                                <?php while (have_rows('interviewee_info')): the_row() ?>
                                    <div class="post-header-info-desktop">
                                        <p>
                                            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/q1.svg">
                                        </p>
                                        ...
                                        <p>
                                            <img
                                                src="<?php bloginfo('stylesheet_directory'); ?>/images/q2.svg">
                                        </p>
